...
const unsplit = (
  object,
  { isReferenceMagicPropertyName, getReferencePartialObject, maxUnsplitDepth }
) => {
  ...
  const unsplitObject = (currentObject, depth) => {
...
module.exports.getSlugifiedUniqueNameFromProperty = getSlugifiedUniqueNameFromProperty;
module.exports.splitPaths = splitPaths;
